...
@Autonomous(name="Auton Blue Backboard Side", group="Autonomous")

public final class AutonMasterLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        OurRobotOk myRobot = new OurRobotOk(build);
                ...
                Actions.runBlocking(new SequentialAction(
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        drive.actionBuilder(drive.pose)
                                                .waitSeconds(1)
                                                .strafeToLinearHeading(new Vector2d(-32, 42), Math.toRadians(270))
                                                .waitSeconds(1)
            ...
            if (teamPropLocation == "right") {
                Actions.runBlocking(
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        drive.actionBuilder(drive.pose)
                                                .strafeToLinearHeading(new Vector2d(-10, 34), Math.toRadians(180))
...
class OurRobotOk{
    ...
    public OurRobotOk(VisionPortal.Builder build1){
        builder = build1;
        initTfod();
    }
