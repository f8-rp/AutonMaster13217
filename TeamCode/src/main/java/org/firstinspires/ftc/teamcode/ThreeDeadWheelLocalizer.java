...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par1YTicks = 14594.998419796006

                ;// y position of the first parallel encoder (in tick units)
        public double par0YTicks = -13072.033155781857; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 4253.457131943826;    // x position of the perpendicular encoder (in tick units)
    }
