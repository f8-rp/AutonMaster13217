...
@Autonomous(name="Auton Red Backboard Side", group="Autonomous")

public final class AutonMasterRedRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        OurRobotRedRight myRobot = new OurRobotRedRight(build);
                        ...
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        drive.actionBuilder(drive.pose)
                                                //-34 64
                                                .strafeToLinearHeading(new Vector2d(-10, -35), Math.toRadians(180))
                                                .strafeToLinearHeading(new Vector2d(-40, -35), Math.toRadians(180))
                ...
                Actions.runBlocking(
                        new ParallelAction(
                                ...
                                new SequentialAction(
                                        drive.actionBuilder(drive.pose)
                                                .waitSeconds(1.5)
                                                .strafeToLinearHeading(new Vector2d(-25, -50), Math.toRadians(90))
                                                .waitSeconds(2)
...
class OurRobotRedRight{
    ...
    public OurRobotRedRight(VisionPortal.Builder build1){
        builder = build1;
        initTfod();
    }
